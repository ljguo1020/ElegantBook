\documentclass[leqno, lang = cn, theme = Fresh Green, fleqn]{elegantbook-l3}


\ExplSyntaxOn
\keys_set:nn { elegant / cover }
{
  info = {
    title = {ElegantBook：优美的 \LaTeX{} 书籍模板},
...
\keys_set:nn { elegant / cover }
{
  info = {
    ...
    title = {Elegant\ Book},
    subtitle = {Elegant\ \LaTeX\ Template},
